 ...
 * @param {*} accessToken Access token obtained from Facebook
 * @param {*} refreshToken Refres token obtained from Facebook
 * @param {*} profile Object containing user information
 * @param {*} done Session management function, introduced in `authenticateFacebookCallback`
 */
