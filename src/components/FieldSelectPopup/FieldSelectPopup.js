...
// The delay after which the accumulated query is cleared when typing pauses
...
const FieldSelectPopupComponent = props => {
  ...
  // The placeholder also has value '', so selectedOption matches it too.
  // hasSelection filters that case out.
