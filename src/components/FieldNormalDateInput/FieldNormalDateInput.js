...
import { IconArrowHead, ValidationError } from '..';
import { useConfiguration } from '../../context/configurationContext';

import { isInRange } from '../../util/dates';
import SingleDatePicker from '../DatePicker/DatePickers/SingleDatePicker';
import css from './FieldNormalDateInput.module.css';
...
class FieldNormalDateInputComponent extends Component {
  render() {
    const {
      className,
      rootClassName,
    ...
    return (
      <div className={classes}>
        ...
        <SingleDatePicker className={inputClasses} {...inputProps} />
...
FieldNormalDateInputComponent.defaultProps = {
  className: null,
  rootClassName: null,
...
FieldNormalDateInputComponent.propTypes = {
  className: string,
...
// export { DateInput };
export default FieldNomalDateInput;
