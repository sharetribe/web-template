...
const SectionTips = () => {
  return (
    <div className={css.sectionbody}>
      <div className={css.sectiontitle}>Tips For A Successful Gathering</div>
      <div className={css.sectioncontent}>
        <div className={css.tipsitem}>
          ...
          <div className={css.tipsdescription}>
            Search for activities that fit those goals. Equally as important, ensure that the
            environment is conducive to building rapport and connection so its remember long after.
          </div>
        </div>
        <div className={css.tipsitem}>
          <svg
          ...
          <div className={css.tipsdescription}>
            Allowing your group to buy-in and feel a part of the process can be a game-changer.
            Allow your team to select their favorite from a small selection of experiences to
            increase participation and excitement.
          </div>
        </div>
        <div className={css.tipsitem}>
          <svg
          ...
          <div className={css.tipsdescription}>
            Bevy Experiences makes it easy to book the preferred experience with all the bells and
            whistles. Make sure to select a preferred date and at least 2 alternative date options.
          </div>
        </div>
        <div className={css.tipsitem}>
          <svg
          ...
          >
            <path
              d="M10.5469 3.125C9.89746 3.125 9.375 3.64746 9.375 4.29688C9.375 4.94629 9.89746 5.46875 10.5469 5.46875H11.3281V7.09473C5.83984 7.67578 1.5625 12.3242 1.5625 17.9688H23.4375C23.4375 12.3242 19.1602 7.67578 13.6719 7.09473V5.46875H14.4531C15.1025 5.46875 15.625 4.94629 15.625 4.29688C15.625 3.64746 15.1025 3.125 14.4531 3.125H12.5H10.5469ZM1.17188 19.5312C0.522461 19.5312 0 20.0537 0 20.7031C0 21.3525 0.522461 21.875 1.17188 21.875H23.8281C24.4775 21.875 25 21.3525 25 20.7031C25 20.0537 24.4775 19.5312 23.8281 19.5312H1.17188Z"
              fill="#06C167"
            />
          </svg>
          <div className={css.tipstitle}>Get Ready for Meaningful Connections!</div>
          <div className={css.tipsdescription}>
            After you've engaged the team and booked the winning activity, its time to make
            meaningful connections that last. At Bevy Experiences, we're committed to giving you
