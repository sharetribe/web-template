...
function CreateStripeAccountFields(props) {
...
function UpdateStripeAccountFields(props) {
  const {
    disabled,
    countryLabel,
    savedCountry,
...
function StripeConnectAccountFormComponent(props) {
