    ...
    return (
        <div className={css.sectionbody}>
            ...
            <div className={css.sectioncontent}>
                ...
                <div className={css.sectioncontentitem2}>
                    <span className={css.itemtitle}>Retreats</span>
                </div>
                <div className={css.sectioncontentitem3}>
                    <span className={css.itemtitle}>Virtual</span>
                </div>
