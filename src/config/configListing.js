...
export const listingExtendedData = [
  ...
  },
  {
    ...
    schemaOptions: [
      ...
      { option: 'air_jordan', label: 'Air Jordan' },
      { option: 'converse', label: 'Converse' },
      { option: 'new_balance', label: 'New Balance' },
      { option: 'nike', label: 'Nike' },
      { option: 'puma', label: 'Puma' },
      { option: 'ultraboost', label: 'Ultraboost' },
  ...
  },
  {
    ...
    schemaType: 'enum',
    schemaOptions: [
      { option: 'smoky', label: 'Smoky' },
      { option: 'electric', label: 'Electric' },
  ...
  },
  {
    ...
    schemaOptions: [
      ...
      { option: 'Swimming pool', label: 'Swimming pool' },
