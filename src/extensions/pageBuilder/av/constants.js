...
// Kept in sync with src/containers/CMSPage/CMSPage.duck.js where the asset ID
// (avPriceSelectorSecionId) is defined.

export { avPriceSelectorSecionId } from '../../../containers/CMSPage/CMSPage.duck';
