...
export const transitions = {
  ...
  BUYER_REFUND_BEFORE_SELLER_CONFIRMED: 'transitions/buyer-refund-before-seller-confirmed',
  SELLER_REFUND_BEFORE_SELLER_CONFIRMED: 'transitions/seller-refund-before-seller-confirmed',
  SELLER_CONFIRM_PURCHASE: 'transitions/seller-confirm-purchase',
  EXPIRE_SELLER_CONFIRM_PERIOD: 'transitions/expire-seller-confirm-period',
  BUYER_REFUND_BEFORE_CAPTURE_INTENT: 'transitions/buyer-refund-before-capture-intent',
  SELLER_REFUND_BEFORE_CAPTURE_INTENT: 'transitions/seller-refund-before-capture-intent',
  OPERATOR_CANCEL_TRANSITION_AFTER_EXPIRE_INTENT:
    'transitions/operator-cancel-transition-after-expire-intent',
  BUYER_MARK_COMPLETE_BEFORE_CAPTURE_INTENT:
    'transitions/buyer-mark-complete-before-capture-intent',
  EXPIRE_PAYMENT_HOLD_PERIOD: 'transitions/expire-payment-hold-period',
  BUYER_MARK_COMPLETE: 'transitions/buyer-mark-complete',
  AUTO_DISABLE_REFUND: 'transitions/auto-disable-refund',
  BUYER_ISSUE_REFUND: 'transitions/buyer-issue-refund',
  SELLER_ISSUE_REFUND: 'transitions/seller-issue-refund',
  SELLER_DISPUTE: 'transitions/seller-dispute',
  SELLER_APPROVE_REFUND: 'transitions/seller-approve-refund',
  OPERATOR_MARK_COMPLETE: 'transitions/operator-mark-complete',
  EXPIRE_DISPUTE_PERIOD: 'transitions/expire-dispute-period',
  OPERATOR_APPROVE_REFUND: 'transitions/operator-approve-refund',
  BUYER_MARK_COMPLETE_REFUND_DISABLED: 'transitions/buyer-mark-complete-refund-disabled',
  AUTO_MARK_COMPLETE: 'transitions/auto-mark-complete',
...
export const states = {
  ...
  PURCHASE_CONFIRMED_BY_BUYER: 'state/purchase-confirmed-by-buyer',
  PAYMENT_EXPIRED: 'state/payment-expired',
  REFUND_BEFORE_CAPTURE: 'state/refund-before-capture',
  PURCHASED: 'state/purchased',
  PURCHASE_EXPIRED: 'state/purchase-expired',
  COMPLETED: 'state/completed',
  STRIPE_INTENT_CAPTURED: 'state/stripe-intent-captured',
  REFUND_DISABLED: 'state/refund-disabled',
  SELLER_HANDLE_DISPUTED: 'state/seller-handle-disputed',
  OPERATOR_HANDLE_DISPUTED: 'state/operator-handle-disputed',
