            ...
            <div className={css.content}>
                <div className={css.contentheader}>
                    <div className={css.contentheadertitle}>
                        <div className={css.contentheadertitletext}>Fresh Pasta Making</div>
                        x Il Fiorista NYC
                    </div>
                    ...
                    <div className={css.leftdetail}>
                        ...
                        <div className={css.leftsectionitem}>
                            ...
                            <div className={css.sectioncontenttext}>
                                Pasta makes everyone happy, right?
                                We'll explore the art of making and forming your choice of pasta. With a classic Il Fiorista nod to seasonal produce, we'll make pasta filling from delicious and nutritious seasonal produce!
                                You'll be welcomed with an Il Fiorista Alpine spritz upon arrival. Then together you break down the basics of pasta - flour, eggs, and water and build those ingredients into delicious pasta dough. Enjoy the pasta you made with salad to accompany your meal!          
                            </div>
                        </div>
                        <div className={css.leftsectionitem}>
                            <div className={css.sectiontitle}>What you'll do</div>
                            <div className={css.sectionitemlist}>
                                <div className={css.sectionitemsm}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                        <g clip-path="url(#clip0_81_2305)">
                                            <path d="M9 1.6875C10.9394 1.6875 12.7994 2.45792 14.1707 3.82928C15.5421 5.20064 16.3125 7.0606 16.3125 9C16.3125 10.9394 15.5421 12.7994 14.1707 14.1707C12.7994 15.5421 10.9394 16.3125 9 16.3125C7.0606 16.3125 5.20064 15.5421 3.82928 14.1707C2.45792 12.7994 1.6875 10.9394 1.6875 9C1.6875 7.0606 2.45792 5.20064 3.82928 3.82928C5.20064 2.45792 7.0606 1.6875 9 1.6875ZM9 18C11.3869 18 13.6761 17.0518 15.364 15.364C17.0518 13.6761 18 11.3869 18 9C18 6.61305 17.0518 4.32387 15.364 2.63604C13.6761 0.948212 11.3869 0 9 0C6.61305 0 4.32387 0.948212 2.63604 2.63604C0.948212 4.32387 0 6.61305 0 9C0 11.3869 0.948212 13.6761 2.63604 15.364C4.32387 17.0518 6.61305 18 9 18Z" fill="#06C167"/>
                                            <path d="M12.9729 6.15571C13.3034 6.48267 13.3034 7.01704 12.9729 7.34751L8.47642 11.8475C8.14947 12.178 7.61509 12.178 7.28462 11.8475L5.03462 9.59751C4.70415 9.27056 4.70767 8.73618 5.03462 8.40572C5.36157 8.07525 5.89595 8.07525 6.22642 8.40572L7.87876 10.0581L11.7811 6.15571C12.1081 5.82525 12.6424 5.82876 12.9729 6.15571Z" fill="#227667"/>
                                        </g>
                                        <defs>
                            ...
                            <div className={css.sectionitemlist}>
                                <div className={css.sectionitemmd}>
                                    ...
                                    <div className={css.itemmdcontent}>
                                        ...
                                        <div className={css.itemmdcontenttext}>Choose options and estimate headcount to get an instant quote for your team.</div>
                                    </div>
                                </div>
                                <div className={css.sectionitemmd}>
                                    ...
                                    <div className={css.itemmdcontent}>
                                        ...
                                        <div className={css.itemmdcontenttext}>Choose your preferred date and time and reserve it in seconds with a deposit.</div>
                                    </div>
                                </div>
                                <div className={css.sectionitemmd}>
                                    ...
                                    <div className={css.itemmdcontent}>
                                        ...
                                        <div className={css.itemmdcontenttext}>Send invites, manage RSVP's, and pay based on final headcount with our all-in-one platform.</div>
                                    </div>
                                </div>
                                <div className={css.sectionitemmd}>
                                    ...
                                    <div className={css.itemmdcontent}>
                                        ...
                                        <div className={css.itemmdcontenttext}>Share key info with a personalized landing page, and meet on location for the big day.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className={css.hostcontent}>
                                <div className={css.hostitem}>
                                    ...
                                    <div className={css.hostdescription}>
                                        ...
                                        <div className={css.hosttext}>Originally born and raised in Vietnam, Chef Leenah spent eight years in the Philippines and five years in Thailand, where she honed her skills in South East Asian Cuisines. Inspired by her mother who used to be the Head Chef at the Embassies, Chef Leenah continued</div>          
                                    </div>
                                </div>          
                                <div className={css.hostitem}>
                        ...
                        <div className={css.leftsectionitem} style={{ paddingBottom: "70px" }}>
                            <div className={css.groupcount}>
                                ...
                                <div className={css.groupcountcontent}>
                                    ...
                                    <div className={css.groupcountcheck} >
                                        Check Availability
                                    </div>          
                                </div>    
                            </div>                                
                        ...
                        <div className={css.sectionprice}>
                            ...
                            <div className={css.instantbooking}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="11" viewBox="0 0 8 11" fill="none">
                                    <g clip-path="url(#clip0_57_1665)">
                                        <path d="M0 5.5L0.59375 0.601562C0.635417 0.257812 0.91875 0 1.25625 0H4.76875C5.08125 0 5.33333 0.259961 5.33333 0.582227C5.33333 0.650977 5.32083 0.721875 5.29792 0.786328L4.33333 3.4375H7.23542C7.65625 3.4375 8 3.78984 8 4.22598C8 4.38496 7.95417 4.53965 7.86667 4.6707L3.8625 10.7078C3.73958 10.8926 3.5375 11.0021 3.32292 11.0021H3.2625C2.93542 11.0021 2.66875 10.7271 2.66875 10.3898C2.66875 10.3404 2.675 10.291 2.6875 10.2416L3.66667 6.1875H0.666667C0.297917 6.1875 0 5.88027 0 5.5Z" fill="white"/>
                                    </g>
                                    <defs>
                            ...
                            <div className={css.sectionvideocontent}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="69" viewBox="0 0 70 69" fill="none">
                                    <g filter="url(#filter0_b_62_1788)">
                                        <rect x="0.5" width="69" height="69" rx="34.5" fill="white" fill-opacity="0.8"/>
                                    ...
                                    <defs>
                                        <filter id="filter0_b_62_1788" x="-9.5" y="-10" width="89" height="89" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                        <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                                        <feGaussianBlur in="BackgroundImageFix" stdDeviation="5"/>
                                        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_62_1788"/>
                                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_62_1788" result="shape"/>
                                        </filter>
                                    </defs>
                                </svg>
                            </div>      
