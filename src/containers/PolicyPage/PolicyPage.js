...
export const PolicyPageComponent = props => {
  return (
    <Page title={'Privacy Policy'} className={css.page} scrollingDisabled={false}>
...
const PolicyPage = compose(connect(mapStateToProps))(PolicyPageComponent);
