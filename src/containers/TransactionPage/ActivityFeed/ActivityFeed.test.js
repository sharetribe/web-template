    ...
    const props = {
      messages: [
        createMessage(
          'msg1',
          { content: 'hello', createdAt: new Date(Date.UTC(2023, 10, 9, 8, 12)) },
          { sender: provider, publicFileAttachments: [] }
        ),
      ],
      transaction: createTransaction({
        id: 'tx1',
    ...
    const props = {
      messages: [
        createMessage(
          'msg1',
          { content: 'hello', createdAt: new Date(Date.UTC(2023, 10, 9, 8, 12)) },
          { sender: customer, publicFileAttachments: [createFileAttachment('pf1', 'spec.pdf')] }
        ),
      ],
      transaction: createTransaction({
        id: 'tx1',
    ...
    const props = {
      messages: [
        createMessage(
          ...
          {
            sender: provider,
            publicFileAttachments: [createFileAttachment('pf-uuid-1', 'report.pdf')],
          }
        ),
      ],
      transaction: createTransaction({
