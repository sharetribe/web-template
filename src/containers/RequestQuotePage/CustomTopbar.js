...
/**
 * A component that renders the custom topbar for the RequestQuotePage.
 * We don't want to use the default topbar because there are too many
 * links leading away from the RequestQuotePage.
 *
 * @component
 * @param {Object} props
  ...
  return (
    <nav className={classes}>
      <LinkedLogo
        ...
        alt={intl.formatMessage({ id: 'RequestQuotePage.goToLandingPage' })}
