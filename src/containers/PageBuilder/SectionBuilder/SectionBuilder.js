  ...
  return (
    <>
      {sectionsWithResolvedIds.map((section, index) => {
        ...
        const customOption = parseSectionCustomOptions(section.sectionName);
        const ctaOverride = parseSectionCtaClass(section.sectionName, css);
