          ...
          <div className={css.sectioncontent1main}>
            <div className={css.sectioncontent1menu}>
              ...
              <div className={css.sectioncontent1rightmenu}>
                <div className={css.sectioncontent1menucontainer}>
                  <div className={css.sectionmenuitem}>About us</div>
                  <div className={css.sectionmenuitem}>Become a host</div>
                  <div className={css.sectionmenuitem}>Blog</div>
                  <div className={css.sectionmenuitem}>Career</div>
                  <div className={css.sectionmenuitem}>Help</div>
                </div>
              </div>
            </div>
