...
import { LinkedLogo, NamedLink, ExternalLink } from '../../../../components';
      ...
      <div className={css.sectioncontent}>
        ...
        <div className={css.sectioncontent2}>
          ...
          <div className={css.sectionsocial}>
            <div
              onMouseOver={() => {
                setHoverItem('instagram');
              }}
              onMouseLeave={() => {
                setHoverItem('');
              }}
              className={
                hoverItem == 'instagram' ? css.sectionsocialitemhover : css.sectionsocialitem
              }
            >
            ...
            <div
              onMouseOver={() => {
                setHoverItem('facebook');
              }}
              onMouseLeave={() => {
                setHoverItem('');
              }}
              className={
                hoverItem == 'facebook' ? css.sectionsocialitemhover : css.sectionsocialitem
              }
            >
            ...
            <div
              onMouseOver={() => {
                setHoverItem('linkedin');
              }}
              onMouseLeave={() => {
                setHoverItem('');
              }}
              className={
                hoverItem == 'linkedin' ? css.sectionsocialitemhover : css.sectionsocialitem
              }
            >
              <ExternalLink
                key={'linkedin'}
            ...
            <div
              onMouseOver={() => {
                setHoverItem('twitter');
              }}
              onMouseLeave={() => {
                setHoverItem('');
              }}
              className={
                hoverItem == 'twitter' ? css.sectionsocialitemhover : css.sectionsocialitem
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              ...
              className={hoverItem == 'tiktok' ? css.sectionsocialitemhover : css.sectionsocialitem}
            >
