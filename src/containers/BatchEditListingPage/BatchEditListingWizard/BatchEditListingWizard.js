...
class BatchEditListingWizard extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (returnedNormallyFromStripe && stripeConnected && !requirementsMissing) {
      return <NamedRedirect name="BatchEditListingPage" params={pathParams} />;
    }
...
BatchEditListingWizard.defaultProps = {
  className: null,
  currentUser: null,
  rootClassName: null,
  listing: null,
...
BatchEditListingWizard.propTypes = {
