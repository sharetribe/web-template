...
import BatchEditListingPage, { EditListingPageComponent } from './BatchEditListingPage';
import {
  AVAILABILITY,
  DELIVERY,
  DETAILS,
  ...
  PRICING,
  PRICING_AND_STOCK,
} from './BatchEditListingWizard/BatchEditListingWizardTab';
...
describe('EditListingPage', () => {
  ...
  it('Purchase: edit flow on details tab', async () => {
    ...
    const { getByText, getByRole, getByLabelText } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
    });
  ...
  it('Purchase: edit flow on pricing-and-stock tab', async () => {
    ...
    const { getByText, getByRole } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
    });
  ...
  it('Purchase: edit flow on photos tab', async () => {
    ...
    const { getByText } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
    });
  ...
  it('Purchase: edit flow no delivery tab', async () => {
    ...
    const { getByText, queryByText } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
    });
  ...
  it('Booking (day): edit flow on availability tab', async () => {
    ...
    const { getByText, getByRole, queryAllByText } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
      withPortals: false,
  ...
  it('Inquiry: edit flow no pricing on details tab', async () => {
    ...
    const { queryByText } = render(<BatchEditListingPage {...props} />, {
      initialState: initialState(listing),
      config,
      routeConfiguration,
    });
