...
It has been modified to be used inside the Sharetribe Web Template.

NOTE: the rest of this document is the original documentation for babel-preset-react-app. It is outdated and may not be accurate.
