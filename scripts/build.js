...
function printHostingInstructions(appPackage, publicUrl, publicPath, buildFolder, useYarn) {
  ...
  console.log();
  console.log('In local development machine you may serve it on production mode by running:');
  console.log();
  console.log(`  NODE_ENV=production PORT=3000 ${chalk.cyan('yarn')} start`);
  console.log();
  console.log('In production server (e.g. Heroku) we recommend you to set the environment');
  console.log(
  ...
  console.log();
  console.log(
    `  ${chalk.yellow('https://www.sharetribe.com/docs/ftw/how-to-deploy-ftw-to-production/')}`
  );
  console.log();
}
